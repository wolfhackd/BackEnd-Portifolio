...
export const PROJECTS = [
    {
        ...
        id: '1',
        created: '19/027/2004',
        description: 'O Let Me Ask é um app de perguntas e respostas em tempo real para lives e eventos, onde os participantes podem enviar questões, votar nas mais relevantes e acompanhar se já foram respondidas. A proposta é organizar a participação do público, promovendo engajamento e clareza na comunicação.',
        fastDescription: 'App de perguntas e respostas em tempo real para eventos e transmissões ao vivo.',
        overview: 'O projeto Let Me Ask foi desenvolvido para modernizar a interação em lives, eventos e conferências, tornando o processo de perguntas mais simples e democrático. A aplicação é totalmente responsiva, conta com autenticação via Google e integrações em tempo real via WebSocket.',
    ...
    },
    {
        ...
        id: '2',
        created: '19/027/2004',
        description: 'Website de música inspirado no Spotify, que permite ao usuário navegar entre playlists, ouvir prévias de faixas e explorar artistas e álbuns.',
        fastDescription: 'Clone funcional do Spotify com navegação fluida e foco em UX e performance.',
        overview: 'O projeto foi desenvolvido para estudar arquitetura de aplicações complexas com React e Node.js, simulando uma plataforma de streaming real. A aplicação inclui rotas dinâmicas, autenticação e integração com uma API de músicas mockada.',
    ...
    },
    {
        ...
        id: '3',
        created: '19/027/2004',
        description: 'O PortuGênio é um projeto web voltado para o ensino e aprimoramento da língua portuguesa, com foco inicial na gramática. A plataforma utiliza inteligência artificial para oferecer correções automáticas, explicações personalizadas e exemplos práticos, tornando o aprendizado mais dinâmico e interativo.',
        fastDescription: 'Plataforma inteligente para aprendizado de gramática com correções automáticas e explicações personalizadas.',
        overview: 'Desenvolvido com React, Node e integração com IA, o PortuGênio busca tornar o estudo de português mais acessível e prático. A aplicação fornece feedback em tempo real, análises gramaticais e sugestões de melhoria baseadas em contexto.',
